...
Train a new CNN model with specified or default hyperparameters.

Usage:
  python cnn.py --train [OPTIONS]

Key Options:
  --model-name NAME         Name of the model (default: cnn_baseline)
...
Examples:
  ...
  python cnn.py --train --model-name my_cnn_model

  # Training with custom hyperparameters
  python cnn.py --train --model-name my_cnn_model --learning-rate 1e-4 --epochs 50

  # Training using optimized hyperparameters from previous optimization
  python cnn.py --train --model-name my_cnn_model --use-best-params

  # Training with specific device and larger batch size
  python cnn.py --train --model-name my_cnn_model --device cuda --batch-size 32
...
Resume training from a saved CNN model checkpoint.

Usage:
  python cnn.py --resume [OPTIONS]

Key Options:
  --model-name NAME         Name of the model to resume (default: cnn_baseline)
...
Examples:
  ...
  python cnn.py --resume --model-name my_cnn_model --epochs 20

  # Resume training with larger batch size
  python cnn.py --resume --model-name my_cnn_model --batch-size 32

Note: The model checkpoint must exist at models/cnn/{model_name}/best_model.pth
...
Run hyperparameter optimization using Optuna to find the best CNN model configuration.

Usage:
  python cnn.py --optimize [OPTIONS]

Key Options:
  --model-name NAME         Name of the model/study (default: cnn_baseline)
  --n-trials N             Number of optimization trials (default: 50)
  --study-name NAME        Custom Optuna study name (default: same as model-name)
  --storage-url URL        Optuna database URL (default: sqlite:///optuna/cnn.db)
...
Examples:
  ...
  python cnn.py --optimize --model-name my_cnn_model --n-trials 100

  # Optimization with custom study name
  python cnn.py --optimize --model-name my_cnn_model --study-name cnn_experiment_v2 --n-trials 50

  # Quick optimization with fewer epochs per trial
  python cnn.py --optimize --model-name my_cnn_model --n-trials 20 --epochs 10

  # Optimization with custom database location
  python cnn.py --optimize --model-name my_cnn_model --storage-url sqlite:///my_cnn_studies.db
...
Evaluate a trained CNN model on the test dataset.

Usage:
  python cnn.py --eval [OPTIONS]

Key Options:
  --model-name NAME         Name of the model to evaluate (default: cnn_baseline)
...
Examples:
  # Basic evaluation
  python cnn.py --eval --model-name my_cnn_model

  # Evaluation on full test set
  python cnn.py --eval --model-name my_cnn_model --full-test-set

  # Evaluation with larger batch size for faster inference
  python cnn.py --eval --model-name my_cnn_model --batch-size 64

  # Force CPU evaluation
  python cnn.py --eval --model-name my_cnn_model --device cpu

Note: The model must have been trained and saved before evaluation. The script will
look for the model checkpoint at models/cnn/{model_name}/best_model.pth
        """
    }
    ...
    if command in help_text:
        ...
        print("Use 'python cnn.py --help' for general help")


def parse_args():
    """Parse command line arguments for CNN experiments"""
    ...
    parser = argparse.ArgumentParser(
        description="CNN model training and evaluation script for code classification",
...
Examples:
  ...
  Training with custom validation and test ratios:
    python cnn.py --train --model-name my_cnn_model --val-ratio 0.15 --test-ratio 0.25

  Complete workflow example:
    # 1. Optimize hyperparameters
    python cnn.py --optimize --model-name best_cnn_model --n-trials 100
    
    # 2. Train with optimized parameters
    python cnn.py --train --model-name best_cnn_model --use-best-params --epochs 50
    
    # 3. Evaluate the final model
    python cnn.py --eval --model-name best_cnn_model --full-test-set

Command-specific help:
    python cnn.py -h train      # Show detailed help for training mode
    python cnn.py -h resume     # Show detailed help for resume mode
    python cnn.py -h optimize   # Show detailed help for optimization mode
    python cnn.py -h eval       # Show detailed help for evaluation mode
        """,
    )

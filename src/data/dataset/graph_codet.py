...
if __name__ == '__main__':
    # Example 1: Load standard graphs
    ...
    # Example 2: Load graphs with suffix (e.g., comments)
    # train_dataset_comments = GraphCoDeTM4('data/codet_graphs/', split='train', suffix='comments')

...
from config.cnn_config import parse_args
import logging
...
if __name__ == "__main__":
    ...
    if not args.disable_tensorboard:
        log_dir = os.path.join(args.log_dir, "CNN", MODEL_NAME)
    ...
    if args.eval:
        ...
        checkpoint_path = f"models/cnn/{MODEL_NAME}/best_model.pth"
        ...
        if args.optimize:
            ...
            save_hyperparameters(study.best_trial.params, study.best_trial.value, "models/cnn", MODEL_NAME)

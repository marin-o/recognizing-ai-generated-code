...
from config.gat_config import parse_args
...
if __name__ == "__main__":
    ...
    if args.eval:
        ...
        checkpoint_path = f"models/gat/{MODEL_NAME}/{MODEL_NAME}_best.pth"
        ...
        if args.optimize:
            ...
            epoch, best_vloss, best_vacc = load_model(
                model, optimizer, save_path="models/gat", scheduler=scheduler
            )
